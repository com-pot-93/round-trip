...
orig_desc = "data/edge_case/original/process_descriptions"
gen_desc = "data/edge_case/changed/process_descriptions"
...
for path, folders, files in os.walk(gen_desc):
    for file_name in files:
        ...
        result = {'example': file_name, 'similarity': sim, 'recall': kpis[0], 'precision': kpis[1]}
...
with pd.ExcelWriter("orig-chang.xlsx") as writer:
    output_frame1.to_excel(writer, sheet_name="orig-edge", index=False)
